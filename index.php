...
<head>
    ...
    <style>
      .modal-header {background:#0fab07;color:#fff;font-weight:800;}
      .modal-body{font-weight:800;}
      .modal-body ul{list-style:none;}
      .modal .btn {background:#0fab07;color:#fff;}
      .modal a{color:#0fab07;}
      .modal-backdrop {position:inherit !important;}
       #login_button,#register_button{background:none;color:#0ffc03!important;}       
       #query_button {position:fixed;right:0px;bottom:0px;padding:10px 80px;
                      background-color:#0fab07;color:#fff;border-color:#0fab07;border-radius:2px;}
  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="padding: 10px;"><img class="img-responsive" alt="Brand" src="img/logo1.jpg"  style="width: 147px;margin: 0px;"></a>
        </div>
...
?>
      ...
      <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
          <div>
              <form role="search" method="POST" action="Result.php">
                  <input type="text" class="form-control" name="keyword" style="width:80%;margin:20px 10% 20px 10%;" placeholder="Search for a plant">
              </form>
          </div>
      </div>
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="background:#1eba06;color:#fff;font-weight:800;border:none;padding:15px;"> The Plant Shop </div>
                  <ul>
                      <li> <a href="Product.php?value=entrance%20exam"> Monstera Thai Constellation </a> </li>
                      <li> <a href="Product.php?value=Literature%20and%20Fiction"> Succulents </a> </li>
                      <li> <a href="Product.php?value=Academic%20and%20Professional"> Philodendrum </a> </li>
                      <li> <a href="Product.php?value=Academic%20and%20Professional"> Ofertas </a> </li>
                 </ul>
              </div>
                  ...
                  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                      ...
                      <div class="carousel-inner" role="listbox">
                          <div class="item active">
                            <img class="img-responsive" src="img/plants/leuconera1.jpg">
                          </div>

                          <div class="item">
                          <img class="img-responsive" src="img/plants/leuconera2.jpg">
                          </div>

                          <div class="item">
                          <img class="img-responsive" src="img/plants/leuconera3.jpg">
                          </div>

                          <div class="item">
                          <img class="img-responsive" src="img/plants/leuconera4.jpg">
                          </div>

                          <div class="item">
                          <img class="img-responsive" src="img/plants/leuconera5.jpg">
                          </div>
              ...
              <div class="col-md-3 col-lg-3" id="offer">
                  <a href="Product.php?value=Regional%20Books">              <img class="img-responsive center-block" src="img/plants/monsteraThai1.jpg"></a>
                  <a href="Product.php?value=Health%20and%20Cooking">        <img class="img-responsive center-block" src="img/plants/nanouk1.jpg"></a>
                  <!-- <a href="Product.php?value=Academic%20and%20Professional"> <img class="img-responsive center-block" src="img/plants/stringOfHeart1.jpg"></a> -->
              </div>
          </div>
      </div>
  </div>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-1&category=new">
              <div class="book-block">
                  ...
                  <img class="book block-center img-responsive" src="img/plants/stringOfHeart2.jpg">
                  <hr>
                  String of heart <br>
                  5€  &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 8 </span>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-2&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/plants/succulentsMix.jpg">
                  <hr>
                  Aucculent Mix  <br>
                  6€ &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 10 </span>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-3&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/plants/portulacaria.jpg">
                  <hr>
                  Portulacaria <br>
                  6€ &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 10 </span>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-4&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/plants/wendilandii1.jpg">
                  <hr>
                  Wendilandii <br>
                  6€ &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 10 </span>
  ...
  <div class="container-fluid text-center" id="new2">
      <div class="row">
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-5&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="book block-center img-responsive" src="img/books/NEW-5.jpg">
                  <hr>
                  Tradescantia Sillamontana Variegata <br>
                  5€  &nbsp
                  <span style="text-decoration:line-through;color:#828282;"> 8 </span>
                  <span class="label label-warning">35%</span>
              </div>
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-6&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/books/NEW-6.jpg">
                  <hr>
                  Monstera adensonni <br>
                  6€ &nbsp
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-7&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/books/NEW-7.jpg">
                  <hr>
                  Maranta Leuconera Lemon Lime <br>
                  6€ &nbsp
          ...
          <div class="col-sm-6 col-md-3 col-lg-3">
           <a href="description.php?ID=NEW-8&category=new">
              <div class="book-block">
                  <div class="tag">New</div>
                  <div class="tag-side"><img src="img/tag.png"></div>
                  <img class="block-center img-responsive" src="img/books/NEW-8.jpg">
                  <hr>
                  Philodendron heartleaf (potos Brasil) <br>
                  6€ &nbsp
  ...
  <div class="container-fluid" id="author">
      <h3 style="color:#1eba06;"> POPULAR PLANT LOVERS </h3>
      <div class="row">
      ...
      <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-sm-4 col-md-3 col-lg-3 text-center">
                  <h2 style="color:#1eba06;">Follow Us At</h2>
                  <div>
